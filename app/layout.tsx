  ...
  return (
    <html lang="ru">
      <body className={`${manrope.className} min-h-screen text-[var(--app-text)]`}>
        <ThemeSync />
        <header className="sticky top-0 z-[260] h-[clamp(64px,9vh,84px)] w-full border-b border-[var(--header-border)] bg-[var(--header-bg)] text-[var(--header-text)] backdrop-blur-md">
